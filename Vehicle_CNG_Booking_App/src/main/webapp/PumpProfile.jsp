...
<%
    // Get user info from session (set during login)
        String PumpName = (String) session.getAttribute("pumpName");
    String OwnerName = (String) session.getAttribute("FullName");
    String OwnerEmail = (String) session.getAttribute("email");
    String OwnerPhone = (String) session.getAttribute("mobile");
    String OwnerCity  = (String) session.getAttribute("city"); // only if stored
    String memberSince = (String) session.getAttribute("memberSince"); // optional
    String Address = (String) session.getAttribute("Address"); // optional
    String State = (String) session.getAttribute("state"); // optional
    String District = (String) session.getAttribute("district"); // optional
    Object priceObj = session.getAttribute("price");  // no cast to String
...
<head>
  ...
  <title>Pump Owner Profile - BookMyCNG</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<h2>Filter Bookings by Month & Year</h2>
<form action="PumpOrders" method="get" style="margin-bottom:20px; text-align:center;" class="filter-form">
    ...
    <button type="submit" class="btn">Get Bookings</button>
</form>
</div>
    ...
    <form>
      <div class="form-grid">
       <div class="form-group">
          ...
          <input type="text" value="<%= PumpName %>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="tel" value="+91<%= OwnerPhone %>">
        </div>
         <div class="form-group">
          <label>State</label>
        ...
        <div class="form-group">
          <label>City</label>
          <input type="text" value="<%= OwnerCity %>">
        </div>
         <div class="form-group">
